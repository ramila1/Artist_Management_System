  ...
  <div class="min-h-screen flex flex-col bg-blue-100">
    ...
    <div class="flex-1 flex">
      ...
      <div class="flex-1 p-6">
        <h2 class="text-center text-xl font-bold mb-4">All Songs</h2>

        <div v-if="mySongs.length" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <div v-for="song in mySongs" :key="song.id" class="bg-white p-4 rounded shadow-md relative">
            <div class="mb-2">
              <strong class="font-bold">Title: </strong> {{ song.title }}
            </div>
            <div class="mb-2">
              <strong class="font-bold">Artist: </strong>{{ song.artist.first_name }} {{ song.artist.last_name }}
            </div>
            <div class="mb-2">
